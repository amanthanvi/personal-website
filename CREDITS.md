...
This file documents open-source dependencies and fonts. **Nothing here is legal advice.**
...
| Font | Role | Source |
|------|------|--------|
| Archivo | Display + UI | [Google Fonts](https://fonts.google.com/specimen/Archivo) (SIL Open Font License 1.1) |
| JetBrains Mono | Labels, metadata, and code | [JetBrains](https://www.jetbrains.com/lp/mono/) (SIL Open Font License 1.1) |
